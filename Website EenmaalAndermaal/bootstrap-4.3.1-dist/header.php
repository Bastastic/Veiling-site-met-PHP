            ...
            <nav class="navbar navbar-dark navbar-expand-md">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarToggler" >
                    <ul class="navbar-nav">
                        ...
                        <li>
                            <div class="col-xs-3">
                                <button  style="background-color: #ffad4f" type="button" class="btn btn-primary">Zoeken</button>
                            </div>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" style="color: #1c1c1c"
                               href="#">Bekijk categorieen</a>
