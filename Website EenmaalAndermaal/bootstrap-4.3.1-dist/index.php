...
=======
>>>>>>> 824e20b5812a989614ae7b751d87b3ef2d43a902
<!doctype html>
<html lang="nl">
                ...
                <nav class="navbar navbar-dark navbar-expand-md">
                    ...
                    <div class="ml-auto">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="inloggen.html" style="background-color: #44355b" class="btn btn-info"
                ...
                <nav class="navbar navbar-dark navbar-expand-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarToggler">
                        <ul class="navbar-nav">
                            ...
                            <li>
                                <div class="col-xs-3">
                                    <button style="background-color: #ffad4f" type="button"
